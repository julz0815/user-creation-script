...
const id = "YOUR VERACODE API ID"; // your API ID, reading from environment variable
const key = "YOUR VERAOCDE API KEY"; // your API key, reading from environment variable
...
const auth = __nccwpck_require__(73);
var call = '';
var apiCall = '';
var payload = '';
function groupByColumn(filePath, columnName) {
...
groupByColumn('./users.csv', 'email')
    .then((groupedData) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (groupedData.hasOwnProperty(key)) {
            ...
            if (call.page.total_elements == 1) {
                ...
                for (const item of group) {
                    ...
                    call = yield createTeam(apiCall, payload);
                    if (call == 'team exists') {
                    ...
                    if (teamsOnFile.find(({ team_name }) => team_name === item.reponame)) {
                        teamFound++;
                    }
                }
                ...
                if (teamsCount < userTeams) {
                    ...
                    call = yield updateUser(apiCall, payloadFull);
                    if (call != null) {
            ...
            "teams":[${payload}]
                ...
                call = yield createUser(apiCall, userCreationPayload);
                //console.log(call)
                if (call.user_id != '') {
...
function findUser(apiCall) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return axios_1.default.get('https://api.veracode.com' + apiCall, {
            headers: {
...
function updateUser(apiCall, payload) {
    return __awaiter(this, void 0, void 0, function* () {
        var options = {
            host: auth.getHost(),
            path: apiCall,
        ...
        return axios_1.default.put('https://api.veracode.com' + apiCall, payload, {
            headers: {
...
function createTeam(apiCall, payload) {
    return __awaiter(this, void 0, void 0, function* () {
        var options = {
            host: auth.getHost(),
            path: apiCall,
        ...
        return axios_1.default.post('https://api.veracode.com' + apiCall, payload, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': auth.generateHeader(options.path, options.method)
            }
...
function createUser(apiCall, payload) {
    return __awaiter(this, void 0, void 0, function* () {
        var options = {
            host: auth.getHost(),
            path: apiCall,
